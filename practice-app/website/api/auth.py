...
def signup():
    ...
    access_token = create_access_token(additional_claims={
                                       "user_id": new_user.id, "user_type": "artist" if is_artist else "user"})
...
def login():
    ...
    access_token = create_access_token(identity=user, additional_claims={
                                       "user_id": user.id, "user_type": "artist" if artist else "user"})
