...
class DataProp {
    ...
    fun a() : Boolean {
        ...
        artItemInfo2.labels = mutableListOf("classical", "painting")
    ...
    fun b() : Boolean {
        ...
        eventInfo1.category = mutableListOf("kubism", "oil painting", "wooden sculpture")
        ...
        eventInfo1.labels = mutableListOf("romantic", "engraving", "carving")
        ...
        eventInfo2.category = mutableListOf("mosaic", "seramic")
        ...
        eventInfo2.labels = mutableListOf("mystery", "ceramic", "wood")
